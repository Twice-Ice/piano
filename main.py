...
screen = pygame.display.set_mode((1920, 1080))#creates game screen
xpos = 0
ypos = 0
...
k18 = pygame.mixer.Sound("key18.mp3")
k20 = pygame.mixer.Sound("key20.mp3")
k22 = pygame.mixer.Sound("key22.mp3")
...
while True:
    ...
    if mousePos[0] > 0 and mousePos[0] < 100 and mousePos[1] >500:
        ...
        key = 20
    elif mousePos[0] > 1200 and mousePos[0] < 1300 and mousePos[1] >500:
        key = 22
    elif mousePos[0] > 1300 and mousePos[0] < 1400 and mousePos[1] >500:
        key = 24
    #add more keys here!
    else:
        key = 0
    ...
    pygame.draw.rect(screen, (255, 255, 255), (1200, 500, 100, 300))
    pygame.draw.rect(screen, (255, 255, 255), (1300, 500, 100, 300))
    #key outlines
    ...
    pygame.draw.rect(screen, (0, 0, 0), (1200, 500, 100, 300), 2)
    pygame.draw.rect(screen, (0, 0, 0), (1300, 500, 100, 300), 2)
    ...
    if press == True:
        if key == 0:
            ...
            pygame.mixer.Sound.play(k18)
            pygame.draw.rect(screen, (150,150,150), (1000,500,100,300))
        elif key == 20:
            pygame.mixer.Sound.play(k20)
            pygame.draw.rect(screen, (150,150,150), (1100,500,100,300))
        elif key == 22:
            pygame.mixer.Sound.play(k22)
            pygame.draw.rect(screen, (150,150,150), (1200,500,100,300))
        elif key == 24:
            pygame.mixer.Sound.play(k24)
            pygame.draw.rect(screen, (150,150,150), (1300,500,100,300))
